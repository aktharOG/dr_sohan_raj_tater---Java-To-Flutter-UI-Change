...
class PublicOpinionScreen extends StatefulWidget {
  const PublicOpinionScreen({super.key});

  @override
  State<PublicOpinionScreen> createState() => _DetailsScreenState();
}

class _DetailsScreenState extends State<PublicOpinionScreen> {
  @override
  void initState() {
